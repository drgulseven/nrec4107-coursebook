...
::: {.callout-tip}
For final project interpretation checks, see [Appendix C. Project Checklist](../appendices/appendix-c-project-checklist.qmd).
:::
...
$$
\ln(Price_i) = \beta_0 + \beta_1 \ln(Volume_i) + u_i
$$

Interpretation:

> A 1 percent increase in volume is associated with an estimated \(\beta_1\) percent increase in price.
